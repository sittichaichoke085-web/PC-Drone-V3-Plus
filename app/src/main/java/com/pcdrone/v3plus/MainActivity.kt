...
class MainActivity : Activity() {
    ...
    private fun showJobHistory() {
        ...
        processShareButton.setOnClickListener {
            ...
            > {
                ...
                month.setOnEditorActionListener {
                    _, actionId, _ ->
            ...
            val fromDay =
                fromResult.second.first

            val fromMonth =
                fromResult.second.second

            val fromYear =
                fromResult.second.third

            val toDay =
                toResult.second.first

            val toMonth =
                toResult.second.second

            val toYear =
                toResult.second.third

            fromYear.setOnEditorActionListener {
                _, actionId, _ ->
            ...
            dialog.setOnShowListener {
                ...
                val searchRangeButton =
                    dialog.getButton(
                        android.app.AlertDialog.BUTTON_POSITIVE
                    )

                searchRangeButton.setTextColor(
                    android.graphics.Color.rgb(
                        0, 105, 55
                    )
                )
                ...
                searchRangeButton.setOnClickListener {
                    ...
                    val values =
                        listOf(
                            fromDay.text.toString().trim(),
                            fromMonth.text.toString().trim(),
                            fromYear.text.toString().trim(),
                            toDay.text.toString().trim(),
                            toMonth.text.toString().trim(),
                            toYear.text.toString().trim()
                        )
                    ...
                    if (
                        ...
                        android.widget.Toast.makeText(
                            this,
                            "กรุณากรอกวันที่ จาก–ถึง ให้ครบ",
                            android.widget.Toast.LENGTH_SHORT
                        ).show()
                    ...
                    android.widget.Toast.makeText(
                        this,
                        "ช่วงวันที่ $fromDisplay ถึง $toDisplay พร้อมประมวลผล",
                        android.widget.Toast.LENGTH_LONG
                    ).show()

                    // PHASE 3.3B:
                    // fromMillis / toMillis จะถูกส่งไปหน้า A4 Preview
                }
            }
