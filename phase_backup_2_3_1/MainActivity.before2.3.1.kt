    ...
    private fun showSettings() {
        ...
        root.addView(
            android.widget.TextView(this).apply {
                ...
                text =
                    "ตั้งค่าข้อมูลกิจการ งานบิน การเงิน และรูปแบบรายงาน"
        ...
        root.addView(businessName)
        root.addView(ownerName)
        root.addView(phone)
        ...
        root.addView(
            android.widget.TextView(this).apply {
                ...
                text =
                    "ใช้เป็นราคาเริ่มต้นตอนสร้างงานใหม่ สามารถแก้เฉพาะงานได้ภายหลัง"
        ...
        root.addView(sprayRate)
        root.addView(fertilizerRate)
        root.addView(seedRate)
        root.addView(orchardRate)
        ...
        root.addView(openingBalance)

        root.addView(
            android.widget.TextView(this).apply {

                text =
                    "ยอดเงินตั้งต้น + รายรับ - รายจ่าย = เงินคงเหลือ"
        ...
        val includeJobDetails =
            android.widget.CheckBox(this).apply {

                text =
                    "แสดงรายละเอียดงานบินในรายงาน"

                textSize = 16f

                isChecked =
                    prefs.getBoolean(
                        "setting_report_job_details",
                        true
                    )
            }
        ...
        val includeNotes =
            android.widget.CheckBox(this).apply {
                ...
                text =
                    "แสดงหมายเหตุในรายงาน"

                textSize = 16f

                isChecked =
                    prefs.getBoolean(
                        "setting_report_notes",
                        true
                    )
            }
        ...
        val includeBalance =
            android.widget.CheckBox(this).apply {
                ...
                isChecked =
                    prefs.getBoolean(
                        "setting_report_balance",
                        true
                    )
            }

        val onlyCompletedJobs =
            android.widget.CheckBox(this).apply {

                text =
                    "นับรายได้เฉพาะงานที่สถานะเสร็จแล้ว"
        ...
        root.addView(includeJobDetails)
        root.addView(includeNotes)
        root.addView(includeBalance)
        root.addView(onlyCompletedJobs)
        ...
        paperSpinner.setSelection(
            paperOptions.indexOf(
                savedPaper
            ).coerceAtLeast(0)
        )
            ...
            android.widget.Button(this).apply {
                ...
                setOnClickListener {
                    ...
                    prefs.edit()
                        ...
                        .putBoolean(
                            "setting_report_job_details",
                            includeJobDetails.isChecked
                        )

                        .putBoolean(
                            "setting_report_notes",
                            includeNotes.isChecked
                        )
                        ...
                        .putBoolean(
                            "setting_only_completed_jobs",
                            onlyCompletedJobs.isChecked
                        )

                        .putString(
                            "setting_paper",
                            paperSpinner.selectedItem
                                .toString()
                        )
        ...
        root.addView(
            android.widget.TextView(this).apply {
                ...
                text =
                    "Phase 2.2 จะนำค่าชุดนี้ไปใช้สร้างรายงานรายวัน รายเดือน และรายปี"
