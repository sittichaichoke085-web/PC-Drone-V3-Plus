        ...
        val searchButton =
            android.widget.Button(this).apply {
                ...
                setOnClickListener {
                    ...
                    /*
                     * STEP 3B.1
                     * ค้นหา finance_transactions จาก SharedPreferences
                     * ที่แอปมีอยู่จริงทั้งหมด ไม่เดาชื่อไฟล์
                     */
                    val financePrefNames =
                        listOf(
                            "pc_drone_v3_data",
                            "pc_drone_data",
                            "pc_drone_settings"
                    ...
                    var financeSourceName = ""

                    for (prefName in financePrefNames) {
                        ...
                        /*
                         * รองรับกรณีบางเวอร์ชันบันทึกเป็น String
                         */
                        val fromString =
                            try {
                                candidatePrefs.getString(
                                    "finance_transactions",
                                    null
                                )
                            } catch (_: Exception) {
...
")
                    ...
                    val sourceInfo =
                        if (financeSourceName.isBlank()) {
                            "ไม่พบแหล่งข้อมูลการเงิน"
                        } else {
                            "เชื่อมข้อมูลการเงินแล้ว"
                        }
