    ...
    private fun showReports() {
        ...
        root.addView(
            android.widget.TextView(this).apply {
                text = "รายงาน"
                textSize = 30f
                setTextColor(android.graphics.Color.rgb(0, 105, 50))
        ...
        root.addView(
            android.widget.TextView(this).apply {
                text = "ค้นหารายงานตามวันที่และเตรียมข้อมูลสำหรับเอกสาร A4"
                textSize = 16f
        ...
        fun label(textValue: String): android.widget.TextView {
            return android.widget.TextView(this).apply {
                text = textValue
                textSize = 19f
        ...
        fun createDateRow():
            ...
            row.addView(year, large)

            /*
             * กรอกครบ 2 หลัก -> ไปช่องถัดไปอัตโนมัติ
             */
        ...
        root.addView(label("จากวันที่"))

        val from = createDateRow()
        ...
        root.addView(label("ถึงวันที่"))

        val to = createDateRow()
        ...
        root.addView(
            android.widget.TextView(this).apply {
                ...
                textSize = 13f
                setTextColor(android.graphics.Color.GRAY)
                setPadding(dp(10), 0, 0, dp(14))
            }
        )

        /*
         * ใส่วันที่วันนี้เป็นค่าเริ่มต้น
         * แสดงเป็น พ.ศ.
         */
        ...
        val resultText =
            android.widget.TextView(this).apply {
                ...
                text =
                    "เลือกวันที่แล้วกดค้นหาและประมวลผลรายงาน"
        ...
        val searchButton =
            android.widget.Button(this).apply {
                ...
                setOnClickListener {
                    ...
                    fun buddhistDate(ms: Long): String {
                    ...
                    resultText.text =
                        "ช่วงวันที่ที่เลือก\n" +
                        buddhistDate(fromMillis) +
                        " ถึง " +
                        buddhistDate(toMillis) +
                        "\n\n" +
                        "เขตเวลา: Asia/Bangkok (ICT UTC+7)\n\n" +
                        "พร้อมสำหรับเชื่อมข้อมูลการเงินจริงใน STEP 3B"
                }
            }
