...
class MainActivity : Activity() {
    ...
    private fun showReports() {
        ...
        var latestPdfFrom = 0L
        var latestPdfTo = 0L
        var latestPdfIncome = 0.0
        var latestPdfExpense = 0.0
        var latestPdfBalance = 0.0
        ...
        val searchButton =
            android.widget.Button(this).apply {
                ...
                setOnClickListener {
                    ...
                    pdfFrom = fromMillis
                    pdfTo = toMillis
                    pdfIncome = totalIncome
                    pdfExpense = totalExpense
                    pdfBalance = runningBalance
        ...
        val pdfButton =
            android.widget.Button(this).apply {
                ...
                setOnClickListener {
                    ...
                    if (
                        latestPdfRows.isEmpty()
                    ) {

                        android.widget.Toast.makeText(
                            this@MainActivity,
                            "กรุณาค้นหาและประมวลผลรายงานก่อน",
                            android.widget.Toast.LENGTH_SHORT
                        ).show()
    ...
    private fun createAndShareFinancePdf(
        ...
        try {
            ...
            for (
                pageNumber in 0 until pageCount
            ) {
                ...
                // PC DRONE มุมซ้าย
                normalPaint.textAlign =
                    android.graphics.Paint.Align.LEFT

                normalPaint.typeface =
                    android.graphics.Typeface.DEFAULT_BOLD
